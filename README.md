...
| **Python & Ruby scripts** | Asset management             |
...
```bash
git clone https://github.com/alifazelidehkordi/xpense.git
cd xpense
```
...
4. Replace the existing file inside the project

---

## 4️⃣ Run the App

Select an **iOS simulator or device** and press:
...
GitHub:
[https://github.com/alifazelidehkordi](https://github.com/alifazelidehkordi)
